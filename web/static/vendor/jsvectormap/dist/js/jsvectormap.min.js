!(function (t, e) {
  ...
  var b = (function () {
    ...
    k = (function (t) {
      function e(e) {
        ...
        return (
          ...
          (i._defsElement = new b('defs')),
          (i._rootElement = new b('g', { id: 'jvm-regions-group' })),
    ...
    j = {
      ...
      off: function (t, e, i) {
        var s = e.split(':')[1];
        t.removeEventListener(s, i), delete x[i._uid];
      },
      flush: function () {
        Object.keys(x).forEach(function (t) {
          j.off(x[t].selector, t, x[t].handler);
        });
      },
  ...
  var O = (function () {
      ...
      return (
        (t.prototype.dispose = function () {
          ...
          for (
            var t, e = y(Object.getOwnPropertyNames(this));
            !(t = e()).done;
    ...
    P = (function () {
      function t(t, e, i) {
        void 0 === t && (t = {}),
          ...
          'object' == typeof t.scale && (this.scale = new z(t.scale)),
          this.config.legend &&
            (this.legend = new T(
  ...
  (D.degRad = 180 / Math.PI), (D.radDeg = Math.PI / 180), (D.radius = 6381372);
  var I = {
      _setupContainerEvents: function () {
        ...
        this.params.draggable &&
          (j.on(this.container, 'mousemove', function (i) {
            if (!s) return !1;
          ...
          j.on(this.container, 'mousedown', function (i) {
            return (s = !0), (t = i.pageX), (e = i.pageY), !1;
          }),
          j.on(document.body, 'mouseup', function () {
            s = !1;
          })),
          this.params.zoomOnScroll &&
            j.on(this.container, 'wheel', function (t) {
              var e = 0;
      ...
      _setupElementEvents: function () {
        var t,
          ...
          s = this,
          a = this.container;
        j.on(a, 'mousemove', function (s) {
          Math.abs(t - s.pageX) + Math.abs(e - s.pageY) > 2 && (i = !0);
        }),
          j.delegate(a, 'mousedown', '.jvm-element', function (s) {
            (t = s.pageX), (e = s.pageY), (i = !1);
          }),
          j.delegate(a, 'mouseover mouseout', '.jvm-element', function (t) {
            var e = L(s, this, !0),
          ...
          j.delegate(a, 'mouseup', '.jvm-element', function (t) {
            var e = L(s, this);
            if (
              !i &&
          ...
          j.delegate(a, 'click', '.jvm-element', function (t) {
            var e = L(s, this),
              i = e.type,
              a = e.code;
            s._emit('region' === i ? C.onRegionClick : C.onMarkerClick, [t, a]);
          });
      },
      ...
      _setupContainerTouchEvents: function () {
        ...
        j.on(o.container, 'touchstart', h), j.on(o.container, 'touchmove', h);
      },
      ...
      _createLines: function (t, e, i) {
        ...
        t)) {
          ...
          !1 !== s &&
            !1 !== a &&
            (this.lines[p(r.from, r.to)] = new Y({
              index: n,
              map: this,
              style: u(
      ...
      _createSeries: function () {
        ...
        this.params.series))
          for (var e = 0; e < this.params.series[t].length; e++)
            this.series[t][e] = new P(this.params.series[t][e], this[t], this);
      },
            ...
            ? ((o = this.scale),
              ...
              (r = setInterval(function () {
                (g += 1),
                  ...
                  g == v &&
                    (clearInterval(r),
                    m._emit(C.onViewportChange, [m.scale, m.transX, m.transY]));
              }, 10)))
            : ((this.transX = d),
              (this.transY = f),
              (this.scale = t),
              this._applyTransform(),
              this._emit(C.onViewportChange, [
                this.scale,
                this.transX,
                this.transY,
              ]));
    ...
    R = (function (t) {
      ...
      return (
        (i._bindEventListeners = function () {
          var t = this;
          j.on(this._map.container, 'mousemove', function (e) {
      ...
      return (
        (e._init = function () {
          ...
          (this.container = h(t.selector)),
            ...
            (this.canvas = new k(this.container)),
