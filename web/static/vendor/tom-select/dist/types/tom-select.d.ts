...
declare const TomSelect_base: {
  new (): {
    ...
    initializePlugins(
      plugins:
        | string[]
        | import('./contrib/microplugin').TPluginHash
        | import('./contrib/microplugin').TPluginItem[]
    ): void;
...
export default class TomSelect extends TomSelect_base {
  ...
  getSearchOptions(): {
    ...
    sort:
      | string
      | import('@orchidjs/sifter/lib/types').SortFn
      | import('@orchidjs/sifter/lib/types').Sort[];
    nesting: boolean;
  };
  /**
