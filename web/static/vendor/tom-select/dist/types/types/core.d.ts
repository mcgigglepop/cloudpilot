...
export declare type TomCreate = (
  input: string,
  create: TomCreateCallback
) => boolean;
...
export declare type TomTemplate = (
  data: TomOption,
  escape: typeof escape_html
) => string | HTMLElement;
export declare type TomTemplateNull = (
  data: TomOption,
  escape: typeof escape_html
...
export declare type TomClearFilter = (
  option: TomOption,
  value: string
) => boolean;
