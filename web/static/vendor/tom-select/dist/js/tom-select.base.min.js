    ...
    _getSortFunction(e) {
      ...
      if (d) {
        ...
        return function (e, t) {
          var i, s, n;
          for (i = 0; i < d; i++)
            if (((n = l[i].field), (s = a[i] * w(c(n, e), c(n, t))))) return s;
          return 0;
        };
      }
      return null;
  ...
  class X extends (function (e) {
    ...
    constructor(e, t) {
      ...
      if (
        ...
        n.controlInput
          ? ((u = I(n.controlInput)), (this.focus_node = u))
          : ((u = I('<input/>')), (this.focus_node = l));
      (this.wrapper = r),
        (this.dropdown = a),
      ...
      if (((t.ignoreHover = !0), t.isLocked)) 9 !== e.keyCode && K(e);
        ...
        switch (e.keyCode) {
          case 65:
            ...
            break;
          case 27:
            return t.isOpen && (K(e, !0), t.close()), void t.clearActiveItems();
          case 40:
    ...
    setActiveItem(e, t) {
      ...
      if ('single' !== a.settings.mode) {
        ...
        if (
          ...
          ('click' === i && B(j, t)) || ('keydown' === i && B('shiftKey', t))
    ...
    updateOriginalInput(e = {}) {
      ...
      if (t.is_select_tag) {
        ...
        function o(i, s, o) {
          return (
            i || (i = I('<option value="' + N(s) + '">' + N(o) + '</option>')),
