...
!(function (e, t) {
          ...
          return (
            s
              ...
              .forEach((e) => {
                var i = u(e).map(
                  (e) => (
                    (e = e.map((e) => (t.hasOwnProperty(e) ? p(t[e]) : e))),
                    d(e, '')
                  )
                );
                n[e] = d(i);
  ...
  class w {
    ...
    tokenize(e, t, i) {
      ...
      return (
        i &&
          (o = new RegExp('^(' + Object.keys(i).map(m).join('|') + '):(.*)$')),
        n.forEach((e) => {
          let i,
            n = null,
            r = null;
          o && (i = e.match(o)) && ((n = i[1]), (e = i[2])),
            e.length > 0 &&
              ((r = this.settings.diacritics ? h(e) : m(e)),
              t && (r = '\\b' + r)),
            s.push({
              string: e,
        ...
        ? ((h = O.options),
          ...
          y(e.children, (e) => {
            ...
            'optgroup' === (u = e.tagName.toLowerCase())
              ? (((s = f((t = e)))[a] = s[a] || t.getAttribute('label') || ''),
                (s[c] = s[c] || v++),
                (s[r] = s[r] || t.disabled),
                O.optgroups.push(s),
                (i = s[c]),
  ...
  class Y extends (function (e) {
    ...
    constructor(e, t) {
      ...
      (this.settings = n),
        ...
        (this.inputId = G(s, 'tomselect-' + X)),
        (this.isRequired = s.required),
        (this.sifter = new w(this.options, { diacritics: n.diacritics })),
      ...
      var u;
      if (
        (A(r, n.wrapperClass, d, p),
        A(l, n.controlClass),
        W(r, l),
        A(a, n.dropdownClass, p),
        n.copyClassesToDropdown && A(a, d),
        A(c, n.dropdownContentClass),
        W(a, c),
        _(n.dropdownParent || r).appendChild(a),
        I(n.controlInput))
      ) {
        u = _(n.controlInput);
        ...
        n.controlInput
          ? ((u = _(n.controlInput)), (this.focus_node = u))
          : ((u = _('<input/>')), (this.focus_node = l));
      (this.wrapper = r),
        (this.dropdown = a),
    ...
    setup() {
      ...
      (null === t.maxItems || t.maxItems > 1) &&
        ...
        !t.splitOn &&
          t.delimiter &&
          (t.splitOn = new RegExp('\\s*' + m(t.delimiter) + '+\\s*')),
        ...
        K(r, 'click', (t) => {
          ...
          s && e.onItemSelect(t, s)
            ? B(t, !0)
            : '' == i.value && (e.onClick(), B(t, !0));
        }),
        K(a, 'keydown', (t) => e.onKeyDown(t)),
        K(i, 'keypress', (t) => e.onKeyPress(t)),
        K(i, 'input', (t) => e.onInput(t)),
        K(a, 'resize', () => e.positionDropdown(), c),
        K(a, 'blur', (t) => e.onBlur(t)),
        K(a, 'focus', (t) => e.onFocus(t)),
        K(i, 'paste', (t) => e.onPaste(t));
      const v = (t) => {
      ...
      K(document, 'mousedown', v),
        K(window, 'scroll', f, c),
        K(window, 'resize', f, c),
        K(window, 'mousemove', O, c),
        (this._destroy = () => {
        ...
        A(l, 'tomselected', 'ts-hidden-accessible'),
    ...
    sync(e = !0) {
      const t = this,
        i = e ? J(t.input, { delimiter: t.settings.delimiter }) : t.settings;
    ...
    onKeyDown(e) {
      ...
      if (((t.ignoreHover = !0), t.isLocked)) 9 !== e.keyCode && B(e);
        ...
        switch (e.keyCode) {
          case 65:
            if (Q(q, e) && '' == t.control_input.value)
              return B(e), void t.selectAll();
            break;
          case 27:
          ...
          case 13:
            return void (t.canSelect(t.activeOption)
              ? (t.onOptionSelect(e, t.activeOption), B(e))
          ...
          case 9:
            return void (
              ...
              (t.canSelect(t.activeOption) &&
                (t.onOptionSelect(e, t.activeOption), B(e)),
              t.settings.create && t.createItem() && B(e))
            );
          case 8:
          case 46:
    ...
    loadCallback(e, t) {
      ...
      (i.loading = Math.max(i.loading - 1, 0)),
        ...
        i.loading || x(i.wrapper, i.settings.loadingClass),
        i.trigger('load', e, t);
    }
    preload() {
    ...
    setActiveItem(e, t) {
      ...
      if ('single' !== a.settings.mode) {
        ...
        if (
          ...
          ('click' === i && Q(q, t)) || ('keydown' === i && Q('shiftKey', t))
    ...
    setActiveOption(e, t = !0) {
      e !== this.activeOption &&
        ...
        e &&
          ((this.activeOption = e),
          T(this.focus_node, { 'aria-activedescendant': e.getAttribute('id') }),
    ...
    refreshOptions(e = !0) {
      ...
      for (
        ...
        for (
          ...
          (o = r[i]),
            ...
            i > 0 &&
              ((l = l.cloneNode(!0)),
              T(l, { id: n.$id + '-clone-' + i, 'aria-selected': null }),
              l.classList.add('ts-cloned'),
              x(l, 'active')),
            O || c != e || (d ? d.dataset.group === o && (O = l) : (O = l)),
            u[o].appendChild(l);
      }
      ...
      if (
        (v.loading
          ? _('loading')
          : v.settings.shouldLoad.call(v, f)
        ...
        e && !v.isOpen && (v.open(), v.scrollToOption(O, 'auto')),
          v.setActiveOption(O);
    ...
    updateOption(e, t) {
      ...
      a &&
        ...
        (s = i._render('item', t)),
        a.classList.contains('active') && A(s, 'active'),
        j(a, s)),
        (i.lastQuery = null);
    }
    removeOption(e, t) {
    ...
    getItem(e) {
      ...
      var t = N(e);
      return null !== t
        ? this.control.querySelector(`[data-value="${U(t)}"]`)
        : null;
    }
    addItems(e, t) {
      var i = this,
    ...
    updateOriginalInput(e = {}) {
      ...
      if (t.is_select_tag) {
        ...
        function o(i, s, o) {
          return (
            i || (i = _('<option value="' + R(s) + '">' + R(o) + '</option>')),
    ...
    open() {
      ...
      e.isLocked ||
        ...
        e.refreshState(),
        S(e.dropdown, { visibility: 'hidden', display: 'block' }),
        e.positionDropdown(),
        S(e.dropdown, { visibility: 'visible', display: 'block' }),
        e.focus(),
    ...
    deleteSelection(e) {
      ...
      for (B(e, !0), void 0 !== s && r.setCaret(s); l.length; )
        r.removeItem(l.pop());
    ...
    destroy() {
      ...
      e.trigger('destroy'),
        ...
        x(e.input, 'tomselected', 'ts-hidden-accessible'),
        e._destroy(),
    ...
    _render(e, t) {
      ...
      const o = this;
      return (
        ('option' !== e && 'item' != e) || (n = H(t[o.settings.valueField])),
        null == (s = o.settings.render[e].call(this, t, R)) ||
          ((s = _(s)),
          ...
          ('option' !== e && 'item' !== e) ||
            (T(s, { 'data-value': n }),
            'item' === e
              ? (A(s, o.settings.itemClass), T(s, { 'data-ts-item': '' }))
              : (A(s, o.settings.optionClass),
  ...
  return (
    Y.define('change_listener', function () {
      K(this.input, 'change', () => {
        this.sync();
      });
    }),
        ...
        e.on('initialize', () => {
          e.control_input.addEventListener('keydown', (t) => {
            switch (t.keyCode) {
              case 27:
                return (
                  e.isOpen && (B(t, !0), e.close()), void e.clearActiveItems()
                );
              case 9:
                e.focus_node.tabIndex = -1;
            }
          ...
          e.hook('instead', 'onBlur', (i) => {
            ...
            K(e.control_input, 'blur', () => e.onBlur()),
            e.hook('before', 'close', () => {
    ...
    Y.define('optgroup_columns', function () {
      ...
      e.hook('instead', 'onKeyDown', (i) => {
        ...
        if (!e.isOpen || (37 !== i.keyCode && 39 !== i.keyCode))
          return t.call(e, i);
        (e.ignoreHover = !0),
          (r = L(e.activeOption, '[data-group]')),
          (s = P(e.activeOption, '[data-selectable]')),
          r &&
      ...
      (e.setNextUrl = (e, t) => {
        ...
        e.hook('instead', 'loadCallback', (t, i) => {
          l
            ? o &&
              t.length > 0 &&
              (o.dataset.value = t[0][e.settings.valueField])
            : e.clearOptions(d),
            s.call(e, t, i),
            (l = !1);
        }),
