...
!(function (e, t) {
  ...
  class w {
    ...
    tokenize(e, t, i) {
      ...
      return (
        i &&
          (o = new RegExp('^(' + Object.keys(i).map(f).join('|') + '):(.*)$')),
        n.forEach((e) => {
          let i,
            n = null,
            r = null;
        ...
        ? ((h = y.options),
          ...
          O(e.children, (e) => {
            ...
            'optgroup' === (u = e.tagName.toLowerCase())
              ? (((s = m((t = e)))[a] = s[a] || t.getAttribute('label') || ''),
                (s[c] = s[c] || v++),
                (s[r] = s[r] || t.disabled),
                y.optgroups.push(s),
                (i = s[c]),
  ...
  class X extends (function (e) {
    ...
    setup() {
      ...
      (null === t.maxItems || t.maxItems > 1) &&
        ...
        t.load && t.loadThrottle && (t.load = R(t.load, t.loadThrottle)),
        ...
        : t.settings.splitOn &&
          setTimeout(() => {
            ...
            if (e.match(t.settings.splitOn)) {
              ...
              O(i, (e) => {
                (e = D(e)), this.options[e] ? t.addItem(e) : t.createItem(e);
              });
            }
          }, 0);
    }
    ...
    onKeyDown(e) {
      ...
      if (((t.ignoreHover = !0), t.isLocked)) 9 !== e.keyCode && z(e);
        ...
        switch (e.keyCode) {
          case 65:
            if (K($, e) && '' == t.control_input.value)
              return z(e), void t.selectAll();
            break;
          case 27:
            return t.isOpen && (z(e, !0), t.close()), void t.clearActiveItems();
          case 40:
    ...
    setActiveItem(e, t) {
      ...
      if ('single' !== a.settings.mode) {
        ...
        if (
          ...
          ('click' === i && K($, t)) || ('keydown' === i && K('shiftKey', t))
        ...
        for (
          ...
          (o = r[i]),
            ...
            i > 0 &&
              ...
              x(l, 'active')),
            y || c != e || (d ? d.dataset.group === o && (y = l) : (y = l)),
            u[o].appendChild(l);
      }
      ...
      if (
        (v.loading
          ...
          : v.settings.shouldLoad.call(v, m)
            ? 0 === f.items.length && _('no_results')
            : _('not_loading'),
        (a = v.canCreate(m)) && (p = _('option_create')),
        ...
        if (f.items.length > 0) {
          if (
            ...
            let e = 0;
            p && !v.settings.addPrecedence && (e = 1), (y = v.selectable()[e]);
          }
        } else p && (y = p);
    ...
    addItem(e, t) {
      B(this, t ? [] : ['change', 'dropdown_close'], () => {
        var i, s;
        const n = this,
          o = n.settings.mode,
          r = D(e);
    ...
    updateOriginalInput(e = {}) {
      ...
      if (t.is_select_tag) {
        ...
        function o(i, s, o) {
          return (
            i || (i = _('<option value="' + H(s) + '">' + H(o) + '</option>')),
    ...
    deleteSelection(e) {
      ...
      for (z(e, !0), void 0 !== s && r.setCaret(s); l.length; )
        r.removeItem(l.pop());
    ...
    _render(e, t) {
      ...
      const o = this;
      return (
        ('option' !== e && 'item' != e) || (n = N(t[o.settings.valueField])),
        null == (s = o.settings.render[e].call(this, t, H)) ||
          ((s = _(s)),
          ...
          ('option' !== e && 'item' !== e) ||
            (T(s, { 'data-value': n }),
            'item' === e
              ? (C(s, o.settings.itemClass), T(s, { 'data-ts-item': '' }))
        ...
        e.on('initialize', () => {
          e.control_input.addEventListener('keydown', (t) => {
            switch (t.keyCode) {
              case 27:
                return (
                  e.isOpen && (z(t, !0), e.close()), void e.clearActiveItems()
                );
              case 9:
                e.focus_node.tabIndex = -1;
            }
          ...
          e.hook('instead', 'onBlur', (i) => {
            ...
            M(e.control_input, 'blur', () => e.onBlur()),
            e.hook('before', 'close', () => {
