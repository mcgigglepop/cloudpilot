  ...
  'object' == typeof exports && 'object' == typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : 'object' == typeof exports
        ? (exports.HSTableStickyHeader = t())
        : (e.HSTableStickyHeader = t());
})(window, function () {
  return (
    (d = {
      './hs-sticky-header/src/hs.sticky-header.js': function (
        module,
        __webpack_exports__,
        __webpack_require__
      ) {
    ...
    (f.p = ''),
    f((f.s = './hs-sticky-header/src/hs.sticky-header.js')).default
  );
  function f(t) {
