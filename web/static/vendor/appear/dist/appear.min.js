  ...
  return (
    ...
    function (e) {
      return (function () {
        ...
        function i() {
          u(),
            addEventListener('scroll', n, !1),
            addEventListener('resize', n, !1);
        }
        function r() {
          (m = []), p && clearTimeout(p), a();
        }
        function a() {
          removeEventListener('scroll', n, !1),
            removeEventListener('resize', n, !1);
        }
        function u() {
          s ||
            (m.forEach(function (e, n) {
              e && t(e, w.bounds)
                ? v[n] &&
                  ...
                  h++,
                  w.appear && w.appear(e),
                  w.disappear || w.reappear || (m[n] = null))
                : (v[n] === !1 &&
                    (w.disappear && w.disappear(e),
                    g++,
                    w.reappear || (m[n] = null)),
                  (v[n] = !0));
            }),
            w.reappear ||
              (w.appear && (!w.appear || h !== c)) ||
              (w.disappear && (!w.disappear || g !== c)) ||
              ((s = !0), a(), w.done && w.done()));
        }
        function d() {
          if (!f) {
            ...
            var e;
            if (
              (e = 'function' == typeof w.elements ? w.elements() : w.elements)
            ) {
              c = e.length;
              for (var t = 0; c > t; t += 1) m.push(e[t]), v.push(!0);
              i();
            }
          }
        }
